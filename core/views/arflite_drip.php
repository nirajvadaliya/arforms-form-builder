    ...
    function arflite_add_drip_global_setting_block() {
        ...
        ?>
                ...
                <tr>
                    ...
                    <th style="background:none; border:none;height:98px;" class="email-marketer-img-wrapth" colspan="2"><img alt='' src="<?php echo ARFLITEURL; ?>/images/drip.png" align="absmiddle"  height='38px'/></th>
                </tr>
                ...
                <tr>
                    ...
                    <th id="th_drip" class="arf-email-marketer-radioth">
                        <div class="arf_radio_wrapper">
                            ...
                            <span>
                                <label for="drip_18"><?php echo __('Using API', 'arforms-form-builder'); ?></label>
                            </span>
                        </div>
                    </th>
                ...
                <tr id="drip_api_tr1">
                    ...
                    <td class="tdclass arflitelist-id-lbltd"><label class="lblsubtitle"><?php echo __('API Token', 'arforms-form-builder'); ?></label></td>
                    ...
                    <td style="padding-bottom:3px; padding-left:5px;">
                        ...
                        <div class="arferrmessage" id="drip_api_error" style="display:none;"><?php echo __('This field cannot be blank.', 'arforms-form-builder'); ?></div></td>
                    </td>
                </tr>

                <tr id="drip_api_tr1">

                    <td class="tdclass arflitelist-id-lbltd"><label class="lblsubtitle"><?php echo __('Account ID', 'arforms-form-builder'); ?></label></td>

                    <td style="padding-bottom:3px; padding-left:5px;">

                        <input type="text" name="drip_account_id" class="txtmodal1" id="drip_account_id" size="80" onkeyup="show_verify_btn('drip');" value="" />
                        &nbsp; &nbsp;
                            <span id="drip_link"><a href="javascript:void(0);" class="arlinks arf_restricted_control"><?php echo  __( 'Verify', 'arforms-form-builder' ) ; ?></a></span>
                        ...
                        <span id="drip_verify" class="frm_verify_li" style="display:none;"><?php echo __('Verified', 'arforms-form-builder'); ?></span>
                        <span id="drip_error" class="frm_not_verify_li" style="display:none;"><?php echo __('Not Verified', 'arforms-form-builder'); ?></span>
                        <input type="hidden" name="drip_status" id="drip_status" value="" />
                        <div class="arferrmessage" id="drip_account_error" style="display:none;"><?php echo __('This field cannot be blank.', 'arforms-form-builder'); ?></div></td>
                </tr>
                ...
                <tr id="drip_api_tr2">
                    ...
                    <td style=" padding-top:3px; padding-bottom:3px; padding-left:5px; overflow: visible;">
                        ...
                        <div id="drip_del_link" class="arlinks arfemailmarketer-delref-link-div">
                            <a href="javascript:void(0);" onclick="action_autores('refresh', 'drip');"><?php echo __('Refresh List', 'arforms-form-builder'); ?></a>
                            &nbsp;  &nbsp;  &nbsp;  &nbsp;
                            <a href="javascript:void(0);" onclick="action_autores('delete', 'drip');"><?php echo __('Delete Configuration', 'arforms-form-builder'); ?></a>
                        </div>
