...
/**Basic Styling Options */
    ...
    $arf_title_font_size = isset( $new_values['form_title_font_size'] ) ? sanitize_text_field( $new_values['form_title_font_size'] ).'px' : '24px';
    ...
    $arf_label_font_size = isset( $new_values['font_size'] ) ? sanitize_text_field( $new_values['font_size'] ) : '';
...
/** Input Field Options */
    ...
    $text_direction = isset( $new_values['text_direction'] ) ? sanitize_text_field( $new_values['text_direction'] ) : '';
...
if( false == $is_form_save ){
    ...
    echo ".arflite_main_div_{$form_id}{ max-width:{$form_width}{$form_width_unit}; margin:0 auto;}";
...
if( !empty( $loaded_field ) ){
    ...
    if( array_intersect( $loaded_field, $common_field_type_styling ) ){
        ...
        echo $arf_form_cls_prefix . " .arfformfield .controls input:not(.inplace_field):not(.arf_field_option_input_text)".( ( in_array('phone', $loaded_field ) ) ? ",{$arf_form_cls_prefix} .arfformfield .controls input[type=tel]:not(.inplace_field):not(.arf_field_option_input_text)" : "" )."{";
        ...
        echo $arf_form_cls_prefix . " .arfformfield .controls input:not(.inplace_field):not(.arf_field_option_input_text):focus".( ( in_array('phone', $loaded_field ) ) ? ",{$arf_form_cls_prefix} .arfformfield .controls input[type=tel]:focus:not(.inplace_field):not(.arf_field_option_input_text)" : "" )."{";
            echo "border-bottom:{$field_border_width} {$field_border_style} {$base_color};";
        echo "}";

        /** Placeholder - webkit browsers - chrome/edge/opera */
        echo $arf_form_cls_prefix . " .arfformfield .controls input:not(.inplace_field):not(.arf_field_option_input_text)::-webkit-input-placeholder".( ( in_array('phone', $loaded_field ) ) ? ",{$arf_form_cls_prefix} .arfformfield .controls input[type=tel]:not(.inplace_field):not(.arf_field_option_input_text)::-webkit-input-placeholder" : "" )."{";
            echo "color:{$field_text_color};";
            echo "opacity:{$placeholder_opacity}";
        echo "}";

        /** Placeholder - mozilla firefox older versions */
        echo $arf_form_cls_prefix . " .arfformfield .controls input:not(.inplace_field):not(.arf_field_option_input_text):-moz-placeholder".( ( in_array('phone', $loaded_field ) ) ? ",{$arf_form_cls_prefix} .arfformfield .controls input[type=tel]:not(.inplace_field):not(.arf_field_option_input_text):-moz-placeholder" : "" )."{";
            echo "color:{$field_text_color};";
            echo "opacity:{$placeholder_opacity}";
        echo "}";
        ...
        echo $arf_form_cls_prefix . " .arfformfield .controls input:not(.inplace_field):not(.arf_field_option_input_text):-ms-input-placeholder".( ( in_array('phone', $loaded_field ) ) ? ",{$arf_form_cls_prefix} .arfformfield .controls input[type=tel]:not(.inplace_field):not(.arf_field_option_input_text):-ms-input-placeholder" : "" )."{";
            echo "color:{$field_text_color};";
            echo "opacity:{$placeholder_opacity}";
        echo "}";
        ...
        if( $is_prefix_suffix_enable ){
            ...
            echo $arf_form_cls_prefix . " .arfformfield .controls .arf_material_theme_container_with_icons.arf_only_leading_icon input:not(.inplace_field):not(.arf_field_option_input_text) + .arf_material_standard label.arf_main_label".( ( in_array('phone', $loaded_field ) ) ? ",{$arf_form_cls_prefix} .arfformfield .controls .arf_material_theme_container_with_icons.arf_only_leading_icon input[type=tel]:not(.inplace_field):not(.arf_field_option_input_text) + .arf_material_standard label.arf_main_label" : "" )."{";
                echo "padding-left:{$arf_paddingleft_field} !important;";
            echo "}";
            ...
            echo $arf_form_cls_prefix . " .arfformfield .controls .arf_material_theme_container_with_icons.arf_both_icons input:not(.inplace_field):not(.arf_field_option_input_text)".( ( in_array('phone', $loaded_field ) ) ? ",{$arf_form_cls_prefix} .arfformfield .controls .arf_material_theme_container_with_icons.arf_both_icons input[type=tel]:not(.inplace_field):not(.arf_field_option_input_text)" : "" )."{";
                echo "padding-left:{$arf_paddingleft_field} !important;";
                echo "padding-right:{$arf_paddingleft_field} !important;";
            echo "}";

            echo $arf_form_cls_prefix . " .arfformfield .controls .arf_material_theme_container_with_icons.arf_both_icons input:not(.inplace_field):not(.arf_field_option_input_text) + .arf_material_standard label.arf_main_label".( ( in_array('phone', $loaded_field ) ) ? ",{$arf_form_cls_prefix} .arfformfield .controls .arf_material_theme_container_with_icons.arf_both_icons input[type=tel]:not(.inplace_field):not(.arf_field_option_input_text) + .arf_material_standard label.arf_main_label" : "" )."{";
                echo "padding-left:{$arf_paddingleft_field} !important;";
                echo "padding-right:{$arf_paddingleft_field} !important;";
            echo "}";
            ...
            if( in_array( 'phone', $loaded_field ) ){
                if( $is_form_save ){
                     ...
                     echo $arf_form_cls_prefix .".arfformfield .controls .arf_material_theme_container_with_icons.arf_both_icons  input.arf_phone_utils[type=text]:not(.inplace_field):not(.arf_field_option_input_text){
            ...
            if( $is_form_save ){
                ...
                echo $arf_form_cls_prefix . " .arfformfield .controls .arf_material_theme_container_with_icons.arf_only_leading_icon input:not(.inplace_field):not(.arf_field_option_input_text) + label.arf_main_label".( ( in_array('phone', $loaded_field ) ) ? ",{$arf_form_cls_prefix} .arfformfield .controls .arf_material_theme_container_with_icons.arf_only_leading_icon input[type=tel]:not(.inplace_field):not(.arf_field_option_input_text)" : "" )." + label.arf_main_label{";
                    echo "left:{$arf_paddingleft_field};";
                echo "}";

                echo $arf_form_cls_prefix . " .arfformfield .controls .arf_material_theme_container_with_icons.arf_only_trailing_icon input:not(.inplace_field):not(.arf_field_option_input_text) + label.arf_main_label".( ( in_array('phone', $loaded_field ) ) ? ",{$arf_form_cls_prefix} .arfformfield .controls .arf_material_theme_container_with_icons.arf_only_trailing_icon input[type=tel]:not(.inplace_field):not(.arf_field_option_input_text)" : "" )." + label.arf_main_label{";
                    echo "right:{$arf_paddingleft_field};";
                echo "}";

                echo $arf_form_cls_prefix . " .arfformfield .controls .arf_material_theme_container_with_icons.arf_both_icons input:not(.inplace_field):not(.arf_field_option_input_text) + label.arf_main_label".( ( in_array('phone', $loaded_field ) ) ? ",{$arf_form_cls_prefix} .arfformfield .controls .arf_material_theme_container_with_icons.arf_both_icons input[type=tel]:not(.inplace_field):not(.arf_field_option_input_text)" : "" )." + label.arf_main_label{";
                    echo "left:{$arf_paddingleft_field};";
                    echo "right:{$arf_paddingleft_field};";
                echo "}";
            }
    ...
    if( in_array( 'checkbox', $loaded_field ) ){
        ...
        if( $is_checkbox_img_enable ){
            ...
            if( $preview ){
            	...
            	$all_checkbox_fields = $wpdb->get_results( $wpdb->prepare( "SELECT id,field_options FROM ".$ARFLiteMdlDb->fields." WHERE type = %s AND form_id = %s", 'checkbox', $form_id) );
            }
    ...
    if( in_array( 'radio', $loaded_field ) ){
        ...
        if( $is_radio_img_enable ){
            ...
            if( $preview ){
            	...
            	$all_radio_fields = $wpdb->get_results( $wpdb->prepare( "SELECT id,field_options FROM ".$ARFLiteMdlDb->fields." WHERE type = %s AND form_id = %s", 'radio', $form_id) );
            }
    ...
    if( in_array('select', $loaded_field ) ){
        ...
        if( 'ltr' == $arf_input_field_direction ){
            echo "body.rtl {$arf_form_cls_prefix} .sltstandard_front .arf-selectpicker-control.arf_form_field_picker dt i{";
                echo "left:unset;";
                echo "right:8px;";
            echo "}";

            echo "body.rtl {$arf_form_cls_prefix} .sltstandard_front .arf-selectpicker-control.arf_form_field_picker dt span{";
            ...
            echo "body.rtl {$arf_form_cls_prefix} .sltstandard_front .arf-selectpicker-control.arf_form_field_picker dd ul li{";
                echo "text-align:left;";
            echo "}";
        }
