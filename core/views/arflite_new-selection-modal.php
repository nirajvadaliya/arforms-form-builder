<div id="new_form_selection_modal">
	...
	<div class="newform_modal_title_container">
		<div class="newform_modal_title"><?php echo  __( 'New Form', 'arforms-form-builder' ) ; ?></div>
	</div>
	...
	<div class="newform_modal_fields_start_left">
		...
		<div class="arf_form_type_selection_container">
			<div class="arf_radio_wrapper">
				...
				<span>
					<label for="arf_form_type_blank"><?php echo  __( 'Blank Form', 'arforms-form-builder' ) ; ?></label>
				</span>
			</div>
			...
			<div class="arf_radio_wrapper">
				...
				<span>
					<label for="arf_form_type_sample"><?php echo  __( 'Sample Forms', 'arforms-form-builder' ) ; ?><span class="arflite_pro_version_notice">(Premium)</span></label>
				</span>
			</div>
		</div>

		<div class="arf_new_form_option_container">
			<div class="newmodal_field_title "><?php echo  __( 'Form Title', 'arforms-form-builder' ) ; ?>&nbsp;<span class="newmodal_required newformtitle_required">*</span></div>
			<div class="newmodal_field">
				<input name="form_name" id="form_name_new" value="" class="txtmodal1" /><br />
				<div id="form_name_new_required" class="arferrmessage display-none-cls"><?php echo  __( 'Please enter form title', 'arforms-form-builder' ) ; ?></div>
			</div>

			<div class="newmodal_field_title">
				<?php echo  __( 'Form Description', 'arforms-form-builder' ) ; ?>
			</div>
			<div class="newmodal_field">
			...
			<div class="arf_theme_style_container">
				<div class="newmodal_field_title">
					<?php echo  __( 'Select Theme', 'arforms-form-builder' ) ; ?>
				</div>
				<div class="newmodal_field">
					<?php
			    		...
			    		echo $arflitemaincontroller->arflite_selectpicker_dom( 'templete_style', 'templete_style', 'arf_templete_style_dt', 'width:102.6%', 'material', array(), $inputStyle, false, $arfmainforminputstyle_options_cls, false, array(), false, array(), false, 'arf_templete_style_ul');
			    	?>
				</div>
			</div>
			<?php if(is_rtl()){ ?>
		    ...
		    <div class="newmodal_field_title">
	    		<?php echo addslashes(esc_html__('Input Direction','arforms-form-builder'));?>
	    	</div>
		    <div class="newmodal_field">
		    	<?php
		    		...
		    		echo $arflitemaincontroller->arflite_selectpicker_dom( 'arf_rtl_switch_mode', 'arf_load_form_rtl_switch', 'arf_templete_style_dt', 'width:102.6%', 'yes', array(), $direction_opts );
		    	?>
		    </div>
		    <?php } ?>
		</div>
		...
		<div class="arf_sample_template_container">
			 <div class="newmodal_field_title">
				...
				<div>
					<?php echo  __( 'Select Sample', 'arforms-form-builder' ) ; ?>&nbsp;<span class="newmodal_required newformtitle_required">*</span>
				 </div>
				<p class="newmodal_sample_template_required_error"><?php _e( 'Please select any Sample.', 'arforms-form-builder' ); ?></p>
			</div>
	...
	<div id="arfcontinuebtn" >
		<button type="button" class="rounded_button arf_btn_dark_blue" id="submit_new_form" onclick="arflite_submit_form_type();"><?php echo  __( 'Continue', 'arforms-form-builder' ); ?></button>
		<button type="button" class="rounded_button arfnewmodalclose"><?php echo  __( 'Cancel', 'arforms-form-builder' ) ; ?></button>
	</div>
