		...
		?>
			<table class="wp-list-table widefat post arflite-email-marketer-tbl3">
				...
				<tr>
					...
					<th class="email-marketer-img-wrapth" colspan="2"><img alt='' src="<?php echo ARFLITEURL; ?>/images/convertkit.png" align="absmiddle" height='40px' /></th>
				</tr>
				...
				<tr>
					...
					<th id="th_convertkit" class="arf-email-marketer-radioth">
						<div class="arf_radio_wrapper">
							...
							<span>
								<label for="convertkit_17"><?php echo  __( 'Using API', 'arforms-form-builder' ) ; ?></label>
							</span>
						</div>
					</th>
				...
				<tr id="convertkit_api_tr1" class="display-none-cls">
					...
					<td class="tdclass arflitelist-id-lbltd"><label class="lblsubtitle"><?php echo  __( 'API Key', 'arforms-form-builder' ) ; ?></label></td>
					...
					<td class="arfemailinputtd"><input type="text" name="convertkit_api" class="txtmodal1" id="convertkit_api" size="80" onkeyup="show_verify_btn('convertkit');" value="" /> &nbsp; &nbsp;
						...
						<div class="arferrmessage display-none-cls" id="convertkit_api_error" ><?php echo  __( 'This field cannot be blank.', 'arforms-form-builder' ) ; ?></div></td>
				</tr>

				<tr id="convertkit_api_tr1">

					<td class="tdclass arflitelist-id-lbltd"><label class="lblsubtitle"><?php echo  __( 'API Secret', 'arforms-form-builder' ) ; ?></label></td>

					<td class="arfemailinputtd">
						<input type="text" name="convertkit_api_secret" class="txtmodal1" id="convertkit_api_secret" size="80" onkeyup="show_verify_btn('convertkit');" value="<?php echo isset( $convertkit_data->consumer_secret ) ? $convertkit_data->consumer_secret : ''; ?>" /> &nbsp; &nbsp;
						<span id="convertkit_link"><a href="javascript:void(0);" class="arlinks arf_restricted_control"><?php echo  __( 'Verify', 'arforms-form-builder' ) ; ?></a></span>
						<span id="convertkit_loader" class="display-none-cls"><div class="arf_imageloader arfemailmarketerloaderdiv"></div></span>
						<span id="convertkit_verify" class="frm_verify_li display-none-cls"><?php echo  __( 'Verified', 'arforms-form-builder' ) ; ?></span>
						<span id="convertkit_error" class="frm_not_verify_li display-none-cls"><?php echo  __( 'Not Verified', 'arforms-form-builder' ) ; ?></span>
						<input type="hidden" name="convertkit_status" id="convertkit_status" />
						<div class="arferrmessage display-none-cls" id="convertkit_api_secret_error" ><?php echo  __( 'This field cannot be blank.', 'arforms-form-builder' ) ; ?></div>
					</td>
				</tr>
				...
				<tr id="convertkit_api_tr2">
					...
					<td class="tdclass arflitelist-id-lbltd"><label class="lblsubtitle"><?php echo  __( 'List Name', 'arforms-form-builder' ) ; ?></label></td>
					...
					<td class="arfselect-email-marketer-list-td">
						...
						<div id="convertkit_del_link" class="arlinks arfemailmarketer-delref-link-div">
							<a href="javascript:void(0);" onclick="action_autores('refresh', 'convertkit');"><?php echo  __( 'Refresh List', 'arforms-form-builder' ) ; ?></a>
							&nbsp;  &nbsp;  &nbsp;  &nbsp;
							<a href="javascript:void(0);" onclick="action_autores('delete', 'convertkit');"><?php echo  __( 'Delete Configuration', 'arforms-form-builder' ) ; ?></a>
						</div>
