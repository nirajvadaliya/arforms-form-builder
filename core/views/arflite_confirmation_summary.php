...
class arflite_submit_confirmation_summary {
	...
	function arflite_submit_confirmation_summary_options( $id, $values ) {
				...
				<div class="arf_confirmation_summary_enable">
					<div class="arf_popup_checkbox_wrapper arflite_confirmation_summary_checkbox_wrapper">
						<div class="arf_custom_checkbox_div">
							...
							<span>
								<label for="arf_confirmation_summary"><?php echo  __( 'Show confirmation (Summary)', 'arforms-form-builder' ) ; ?><span class="arflite_pro_version_notice">(Premium)</span></label>
							</span>
						</div>
					</div>
				</div>
