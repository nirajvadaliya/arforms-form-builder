...
if( empty( $is_form_save ) ){
    ...
    echo $arf_form_cls_prefix . " .msg-detail { float:left; width: 100%; padding:20px 10px 20px 10px; min-height: 37px; line-height: 37px; text-shadow: none; }";

    echo $arf_form_cls_prefix . " .msg-detail p { padding:0 !important; margin:0 !important; }";

    $msg_font_size = '20px';

    echo $arf_form_cls_prefix . " .msg-title-success { padding:0px 0 0 10px; vertical-align:middle; display:inline-block; font-weight:bold;}";

    echo $arf_form_cls_prefix . " .msg-description-success { letter-spacing:0.1px; padding:10px 0 10px 0px; width:100%; vertical-align:middle; display:inline-block; }";

    echo $arf_form_cls_prefix . " .msg-title-error { padding:5px 0 0 10px; vertical-align:middle; display:inline-block; }";

    echo $arf_form_cls_prefix . " .msg-description-error { padding:7px 0 0 10px; letter-spacing:0.1px; vertical-align:middle; display:inline; }";

    echo $arf_form_cls_prefix . " .arf_res_front_msg_desc { padding:10px 0 10px 0px; letter-spacing:0.1px; width:100%; vertical-align:middle; display:inline-block; text-align:center; }";
...
if( !empty( $loaded_field ) ){
    ...
    if( array_intersect( $loaded_field, $common_field_type_styling ) ){
        echo $arf_form_cls_prefix . " .arfformfield .controls input:not(.inplace_field):not(.arf_field_option_input_text)".( ( in_array('phone', $loaded_field ) ) ? ",{$arf_form_cls_prefix} .arfformfield .controls input[type=tel]:not(.inplace_field):not(.arf_field_option_input_text)" : "" )."{";
            ...
            echo "padding:{$arf_field_inner_padding} !important;";
        ...
        echo $arf_form_cls_prefix . " .arfformfield .controls input:not(.inplace_field):not(.arf_field_option_input_text):focus".( ( in_array('phone', $loaded_field ) ) ? ",{$arf_form_cls_prefix} .arfformfield .controls input[type=tel]:focus:not(.inplace_field):not(.arf_field_option_input_text)" : "" )."{";
            ...
            if( 1 == $arfmainfield_opacity ){
                ...
                echo "background:{$field_focus_bg_color} !important;";
            }
        echo "}";

        echo $arf_form_cls_prefix . " .arfformfield.arf_warning .controls input:not(.inplace_field):not(.arf_field_option_input_text)" . ( ( in_array('phone', $loaded_field ) ) ? ",{$arf_form_cls_prefix} .arfformfield.arf_warning .controls input[type=tel]:not(.inplace_field):not(.arf_field_option_input_text)" : "" ) . "{";
            echo "background:{$field_error_bg_color} !important;";
        echo "}";
        ...
        if($is_prefix_suffix_enable){
            ...
            echo $arf_form_cls_prefix . " .arfformfield {$arf_prefix_cls}.arf_prefix_focus{";
                ...
                echo 'box-shadow:0 0 2px rgba(' . $arflitesettingcontroller->arflitehex2rgb($base_color) . ',0.4);
                -moz-box-shadow:0 0 2px rgba(' . $arflitesettingcontroller->arflitehex2rgb($base_color) . ',0.4);
                -webkit-box-shadow:0 0 2px rgba(' . $arflitesettingcontroller->arflitehex2rgb($base_color) . ',0.4);
                -o-box-shadow:0 0 2px rgba(' . $arflitesettingcontroller->arflitehex2rgb($base_color) . ',0.4);';
            echo "}";
            ...
            echo $arf_form_cls_prefix . " .arf_fieldset .arfformfield .controls {$arf_prefix_suffix_wrapper_cls}.arf_both_pre_suffix input:not(.inplace_field):not(.arf_smiley_input):not(.arf_field_option_input_text)".( ( in_array('phone', $loaded_field ) ) ? ",{$arf_form_cls_prefix} .arfformfield .controls {$arf_prefix_suffix_wrapper_cls}.arf_both_pre_suffix input[type=tel]:not(.inplace_field):not(.arf_field_option_input_text)" : "" )."{";
                echo "width:100%;";
                echo "border-left:none !important;";
                echo "border-right:none !important;";
            ...
            echo ( ( in_array('phone', $loaded_field ) ) ? "{$arf_form_cls_prefix} .arfformfield .controls {$arf_prefix_suffix_wrapper_cls}.arf_both_pre_suffix input.arf_phone_utils[type=text]:not(.inplace_field):not(.arf_field_option_input_text)" : "" )."{";
                echo "padding-left: 52px !important";
            echo "}";

            echo ( ( in_array('phone', $loaded_field ) ) ? "{$arf_form_cls_prefix} .arfformfield .controls input.arf_phone_utils[type=text]:not(.inplace_field):not(.arf_field_option_input_text)" : "" )."{";
                echo "padding-left: 52px !important";
            echo "}";
    ...
    if( in_array('radio', $loaded_field) ){
        ...
        {$arf_form_cls_prefix} .arf_rounded_form .arf_enable_radio_image span.arf_radio_label_image,
    ...
    if( in_array('date', $loaded_field ) || in_array( 'time', $loaded_field) ){
        ...
        {$arf_form_cls_prefix} .arf-glyphicon-calendar:before{
            color:". ( ( $arflitesettingcontroller->arfliteisColorDark($base_color) == '1')?'#ffffff':'#1A1A1A' ). " !important;
        }";
