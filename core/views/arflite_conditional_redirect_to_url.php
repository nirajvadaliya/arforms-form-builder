...
class ARFLITE_conditional_redirect_to_url {
	...
	function arflite_form_submit_after_redirect_to_url_html( $id, $values ) {
		$allowed_html_arr = arflite_retrieve_attrs_for_wp_kses();
		?>

		<div class="arflite_conditional_redirect_to_url_space">&nbsp;</div>

		<div class="arf_or_option arflite_conditional_redirect_to_url_or_label"><?php echo __( 'Or', 'arforms-form-builder' ); ?></div>
		...
		<div class="arfcolumnleft arf_custom_margin_redirect arfsetcondtionalredirect">
			<div class="arf_custom_checkbox_div">
				...
				<span>
					<label for="arf_conditional_redirect_enable"><?php echo __( 'Set conditional redirect URL', 'arforms-form-builder' ); ?> (<span class="howto"><?php echo __( 'Please insert url with http:// or https://.', 'arforms-form-builder' ); ?></span>)<span class="arflite_pro_version_notice">(Premium)</span></label>
				</span>
			</div>
		</div>
