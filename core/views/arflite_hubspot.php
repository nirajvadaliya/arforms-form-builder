		...
		?>
			<table class="wp-list-table widefat post arflite-email-marketer-tbl3">
				...
				<tr>
					...
					<th class="email-marketer-img-wrapth" colspan="2"><img alt='' src="<?php echo ARFLITEURL; ?>/images/hubspot.png" align="absmiddle" height='38px' /></th>
				</tr>
				...
				<tr>
					...
					<th id="th_hubspot" class="arf-email-marketer-radioth">
						<div class="arf_radio_wrapper">
							...
							<span>
								<label for="hubspot_15"><?php echo  __( 'Using API', 'arforms-form-builder' ) ; ?></label>
							</span>
						</div>
					</th>
				...
				<tr id="hubspot_api_tr1">
					...
					<td class="arfemailinputtd"><input type="text" name="hubspot_api" class="txtmodal1" id="hubspot_api" size="80" onkeyup="show_verify_btn('hubspot');" value="" /> &nbsp; &nbsp;
						<span id="hubspot_link" ><a href="javascript:void(0);" class="arlinks arf_restricted_control"><?php echo  __( 'Verify', 'arforms-form-builder' ) ; ?></a></span>
						<span id="hubspot_loader" class="display-none-cls"><div class="arf_imageloader arfemailmarketerloaderdiv"></div></span>
						<span id="hubspot_verify" class="frm_verify_li display-none-cls"><?php echo  __( 'Verified', 'arforms-form-builder' ) ; ?></span>
						<span id="hubspot_error" class="frm_not_verify_li display-none-cls"><?php echo  __( 'Not Verified', 'arforms-form-builder' ) ; ?></span>
						<input type="hidden" name="hubspot_status" id="hubspot_status" value="" />
						<div class="arferrmessage display-none-cls" id="hubspot_api_error"><?php echo  __( 'This field cannot be blank.', 'arforms-form-builder' ) ; ?></div></td>
				</tr>
				...
				<tr id="hubspot_api_tr2">
					...
					<td class="arfselect-email-marketer-list-td">
						...
						<div id="hubspot_del_link" class="arlinks arfemailmarketer-delref-link-div">
							<a href="javascript:void(0);" onclick="action_autores('refresh', 'hubspot');"><?php echo  __( 'Refresh List', 'arforms-form-builder' ) ; ?></a>
							&nbsp;  &nbsp;  &nbsp;  &nbsp;
							<a href="javascript:void(0);" onclick="action_autores('delete', 'hubspot');"><?php echo  __( 'Delete Configuration', 'arforms-form-builder' ) ; ?></a>
						</div>
