...
<input type="text" placeholder="<?php echo  __( 'Search', 'arforms-form-builder' ) ; ?>" id="arf_fontawesome_search" class="textbox arf_fontawesome_search"/>


 <div class="font_awesome_title <?php echo esc_attr($is_rtl); ?>" data-id="1"><?php echo  __( 'General Icons', 'arforms-form-builder' ) ; ?></div>
<div class="fa_subcontent <?php echo esc_attr($is_rtl); ?>" data-id="1">
      <div class="arf_fainsideimge" id="" title="None" no_icon_text="<?php echo  __( 'No Icon', 'arforms-form-builder' ) ; ?>"></div>
            
                  <?php
                  foreach ( $fonts_array_values as $key => $values ) {

                        foreach ( $values as $id => $title ) {
                              echo '<div class="arf_fainsideimge" id="' . esc_attr($id) . '" title="' . esc_attr($title) . '" data-key="' . esc_attr($key) . '"> <i class="' . esc_attr($key) . ' ' . esc_attr($id) . '"></i> </div>';
                        }
                  }
                  ?>
</div>
