<div class="arf_field_option_model" id="arf_field_option_model_skeleton">
	<div class="arf_field_option_model_header"><?php echo  __( 'Field Options', 'arforms-form-builder' ) ; ?></div>
	<div class="arf_field_option_model_container">
		<div class="arf_field_option_content_row">
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="labelname">
				...
				<label class="arf_field_option_content_cell_label" id="arf_label_for_general"><?php echo __( 'Label Name', 'arforms-form-builder' ); ?></label>
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="max_opt_selected">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Max Option Selected', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="max_opt_selected_msg">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Max Option Selected Message', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="min_opt_selected">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Min Option Selected', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="min_opt_selected_msg">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Min Option Selected Message', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="requiredmsg">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Message for blank field', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="number_of_rows">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Number of Rows', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="arf_enable_readonly">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Enable Readonly', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
		 ...
		 <div class="arf_field_option_content_cell" data-sort="-1" id="fieldsize_phone">
			<label class="arf_field_option_content_cell_label"><?php echo  __( 'Field Size (Characters)', 'arforms-form-builder' ) ; ?></label>
			<div class="arf_field_option_content_cell_input">
				...
				<span class="arf_field_option_input_note">
					<span class="arf_field_option_input_note_text"><?php echo  __( 'Maximum', 'arforms-form-builder' ) ; ?></span>
				</span>
			</div>
		</div>	    
		<div class="arf_field_option_content_cell" data-sort="-1" id="fieldsize">
			...
			<div class="arf_field_option_content_cell_input">
				...
				<span class="arf_field_option_input_note">
					<span class="arf_field_option_input_note_text arf_half_width"><?php echo  __( 'Minimum', 'arforms-form-builder' ) ; ?></span>
					<span class="arf_field_option_input_note_text arf_half_width"><?php echo  __( 'Maximum', 'arforms-form-builder' ) ; ?></span>
				</span>
			</div>
		</div>
			<div class="arf_field_option_content_cell" data-sort="-1" id="customwidth">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Field Custom Width', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="minlength_message">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Message for minimum length', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="placeholdertext">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Placeholder Text', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="default_value">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Default Value', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="cleartextonfocus">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Clear default text on focus', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
					<label class="arf_js_switch_label">
						<span><?php echo  __( 'No', 'arforms-form-builder' ) ; ?>&nbsp;</span>
					</label>
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="validatedefaultvalue">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Validate default value', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
					<label class="arf_js_switch_label">
						<span><?php echo  __( 'No', 'arforms-form-builder' ) ; ?>&nbsp;</span>
					</label>
					...
					<label class="arf_js_switch_label"><span><?php echo  __( 'Yes', 'arforms-form-builder' ) ; ?>&nbsp;</span></label>
				</div>
			</div>
			<div class="arf_field_option_content_cell" data-sort="-1" id="fielddescription">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Field description', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="arf_prefix">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Add icon (Bootstrap style)', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
					<div class="arf_field_prefix_suffix_wrapper" id="arf_field_prefix_suffix_wrapper_{arf_field_id}">
						<div class="arf_prefix_wrapper">
							<div class="arf_prefix_suffix_container_wrapper" data-action="edit" data-field="prefix" field-id="{arf_field_id}" id="arf_edit_prefix_{arf_field_id}" data-toggle="arfmodal" href="#arf_fontawesome_modal" data-field_type="text">
								<div class="arf_prefix_container" id="arf_select_prefix_{arf_field_id}"><?php echo  __( 'No icon', 'arforms-form-builder' ) ; ?></div>
						...
						<div class="arf_suffix_wrapper">
							<div class="arf_prefix_suffix_container_wrapper" data-action="edit" data-field="suffix" field-id="{arf_field_id}" id="arf_edit_suffix_{arf_field_id}" data-toggle="arfmodal" href="#arf_fontawesome_modal" data-field_type="text">
								<div class="arf_suffix_container" id="arf_select_suffix_{arf_field_id}"><?php echo  __( 'No icon', 'arforms-form-builder' ); ?></div>
								<div class="arf_prefix_suffix_action_container">
					...
					<span class="arf_field_option_input_note">
						<span class="arf_field_option_input_note_text arf_half_width"><?php echo  __( 'Prefix', 'arforms-form-builder' ); ?></span>
						<span class="arf_field_option_input_note_text arf_half_width "><?php echo  __( 'Suffix', 'arforms-form-builder'  ); ?></span>
					</span>
				</div>
			</div>
			<div class="arf_field_option_content_cell" data-sort="-1" id="alignment">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Alignment', 'arforms-form-builder'  ); ?></label>
				<div class="arf_field_option_content_cell_input">
					<span class='arf_custom_radio_wrapper arf_field_option_radio'>
						...
						<label class="arf_custom_radio_label" for="arf_field_align_{arf_field_id}_1"><?php echo  __( 'Inline', 'arforms-form-builder'  ); ?></label>
					</span>
					<span class="arf_custom_radio_wrapper arf_field_option_radio">
						...
						<label class="arf_custom_radio_label" for="arf_field_align_{arf_field_id}_2"><?php echo  __( '1 Column', 'arforms-form-builder'  ); ?></label>
					</span>
					<span class="arf_custom_radio_wrapper arf_field_option_radio">
						...
						<label class="arf_custom_radio_label" for="arf_field_align_{arf_field_id}_3"><?php echo  __( '2 Column', 'arforms-form-builder'  ); ?></label>
					</span>
					<span class="arf_custom_radio_wrapper arf_field_option_radio">
						...
						<label class="arf_custom_radio_label" for="arf_field_align_{arf_field_id}_4"><?php echo  __( '3 Column', 'arforms-form-builder'  ); ?></label>
					</span>
					<span class="arf_custom_radio_wrapper arf_field_option_radio">
						...
						<label class="arf_custom_radio_label" for="arf_field_align_{arf_field_id}_5"><?php echo  __( '4 Column', 'arforms-form-builder' ); ?></label>
					</span>
				</div>
			</div>		
			
			<div class="arf_field_option_content_cell arf_full_width_cell" id="allowedphonetype">
				<label class="arf_field_option_content_cell_label"><?php echo __( 'Enable country flag dropdown', 'arforms-form-builder' ); ?></label>
				<div class="arf_field_option_content_cell_input">
					<label class="arf_js_switch_label">
						<span><?php echo  __( 'NO', 'arforms-form-builder' ) ; ?>&nbsp;</span>
					</label>
				...
				<div class="arf_field_option_content_cell_input" id="phoneformate_box_{arf_field_id}">
								...
								foreach ( $phonetype_arr as $key => $value ) {
									?>
										<div class="arf_file_type_restriction_item arf_phone_type_item">
											...
											<span><label for="field_options[phtypes_{arf_field_id}][<?php echo esc_attr( $value['code'] ); ?>]" class="howto"><span></span><?php echo str_replace( '|', ', ', $value['name'] ); ?></label></span>
										</div>
										<?php
										$c++;
										unset( $key );
					...
					<div class="arf_radio_wrapper arf_radio_wrapper_padding">
						<span class="arf_check_all_label">
							<a href="javascript:void(0)" onclick="arfliteselectphonetypediv('arf_phone_type_item', 1, 1, '.')"><?php echo  __( 'Check All', 'arforms-form-builder'  ); ?></a>
						</span>
					</div>
					<div class="arf_radio_wrapper arf_radio_wrapper_padding">
						<span class="arf_check_all_label">
							<a href="javascript:void(0)" onclick="arfliteselectphonetypediv('arf_phone_type_item', 0, 1, '.')"><?php echo  __( 'Uncheck All', 'arforms-form-builder'  ); ?></a>
						</span>
					</div>
				</div>
			</div>
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="country_validation">
				<label class="arf_field_option_content_cell_label"><?php echo __( 'Country wise number validation', 'arforms-form-builder' ); ?></label>
				<div class="arf_field_option_content_cell_input">
					<label class="arf_js_switch_label">
						<span><?php echo  __( 'NO', 'arforms-form-builder'  ); ?>&nbsp;</span>
					</label>
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="invalidmessage">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Message for invalid submission', 'arforms-form-builder'  ); ?></label>
				<div class="arf_field_option_content_cell_input">
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="confirm_email">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Confirm Email', 'arforms-form-builder'  ); ?></label>
				<div class="arf_field_option_content_cell_input">
					<label class="arf_js_switch_label">
						<span><?php echo  __( 'NO', 'arforms-form-builder'  ); ?>&nbsp;</span>
					</label>
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="confirm_email_label">
				<label class="arf_field_option_content_cell_label"><?php echo __( 'Confirm Email label', 'arforms-form-builder' ); ?></label>
				<div class="arf_field_option_content_cell_input">
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="invalid_confirm_email">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Message for invalid confirm email', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="confirm_email_placeholder" >
				<label class="arf_field_option_content_cell_label"><?php echo __( 'Confirm email placeholder', 'arforms-form-builder' ); ?></label>
				<div class="arf_field_option_content_cell_input">
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="numberrange">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Number Range', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="phone_validation">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Default Number format', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
					<?php
                        ...
                        echo $arflitemaincontroller->arflite_selectpicker_dom( 'phone_validation', 'phone_validation_{arf_field_id}', '', '', 'international', array(), $phone_options );
                    ?>
				</div>
			</div>
			<div class="arf_field_option_content_cell" data-sort="-1" id="calendarlocalization">
				<?php
				$locales = array(
					'en' => addslashes(esc_html__('English/Western', 'arforms-form-builder')), 'af' => addslashes(esc_html__('Afrikaans', 'arforms-form-builder')),
                    'sq' => addslashes(esc_html__('Albanian', 'arforms-form-builder')), 'ar' => addslashes(esc_html__('Arabic', 'arforms-form-builder')),
                    'hy-am' => addslashes(esc_html__('Armenian', 'arforms-form-builder')),
                    'az' => addslashes(esc_html__('Azerbaijani', 'arforms-form-builder')),
                    'eu' => addslashes(esc_html__('Basque', 'arforms-form-builder')), 'bs' => addslashes(esc_html__('Bosnian', 'arforms-form-builder')),
                    'bg' => addslashes(esc_html__('Bulgarian', 'arforms-form-builder')), 'ca' => addslashes(esc_html__('Catalan', 'arforms-form-builder')),
                    'zh-CN' => addslashes(esc_html__('Chinese Simplified', 'arforms-form-builder')),
                    'zh-TW' => addslashes(esc_html__('Chinese Traditional', 'arforms-form-builder')), 'hr' => addslashes(esc_html__('Croatian', 'arforms-form-builder')),
                    'cs' => addslashes(esc_html__('Czech', 'arforms-form-builder')), 'da' => addslashes(esc_html__('Danish', 'arforms-form-builder')),
                    'nl' => addslashes(esc_html__('Dutch', 'arforms-form-builder')), 'en-GB' => addslashes(esc_html__('English/UK', 'arforms-form-builder')),
                    'eo' => addslashes(esc_html__('Esperanto', 'arforms-form-builder')), 'et' => addslashes(esc_html__('Estonian', 'arforms-form-builder')),
                    'fo' => addslashes(esc_html__('Faroese', 'arforms-form-builder')), 'fa' => addslashes(esc_html__('Farsi/Persian', 'arforms-form-builder')),
                    'fi' => addslashes(esc_html__('Finnish', 'arforms-form-builder')), 'fr' => addslashes(esc_html__('French', 'arforms-form-builder')),
                    'fr-CH' => addslashes(esc_html__('French/Swiss', 'arforms-form-builder')), 'de' => addslashes(esc_html__('German', 'arforms-form-builder')),
                    'el' => addslashes(esc_html__('Greek', 'arforms-form-builder')), 'he' => addslashes(esc_html__('Hebrew', 'arforms-form-builder')),
                    'hu' => addslashes(esc_html__('Hungarian', 'arforms-form-builder')), 'is' => addslashes(esc_html__('Icelandic', 'arforms-form-builder')),
                    'it' => addslashes(esc_html__('Italian', 'arforms-form-builder')), 'ja' => addslashes(esc_html__('Japanese', 'arforms-form-builder')),
                    'ko' => addslashes(esc_html__('Korean', 'arforms-form-builder')), 'lv' => addslashes(esc_html__('Latvian', 'arforms-form-builder')),
                    ...
                    'pt-BR' => addslashes(esc_html__('Portuguese/Brazilian', 'arforms-form-builder')), 'ro' => addslashes(esc_html__('Romanian', 'arforms-form-builder')),
                    'ru' => addslashes(esc_html__('Russian', 'arforms-form-builder')), 'sr' => addslashes(esc_html__('Serbian', 'arforms-form-builder')),
                    'sr-cyrl' => addslashes(esc_html__('Serbian Cyrillic', 'arforms-form-builder')), 'sk' => addslashes(esc_html__('Slovak', 'arforms-form-builder')),
                    'sl' => addslashes(esc_html__('Slovenian', 'arforms-form-builder')), 'es' => addslashes(esc_html__('Spanish', 'arforms-form-builder')),
                    'sv' => addslashes(esc_html__('Swedish', 'arforms-form-builder')), 'ta' => addslashes(esc_html__('Tamil', 'arforms-form-builder')),
                    'th' => addslashes(esc_html__('Thai', 'arforms-form-builder')),
                    'tr' => addslashes(esc_html__('Turkish', 'arforms-form-builder')),
                    'uk' => addslashes(esc_html__('Ukrainian', 'arforms-form-builder')), 'vi' => addslashes(esc_html__('Vietnamese', 'arforms-form-builder'))
				);
				?>
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Calendar localization', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
					<?php
                        echo $arflitemaincontroller->arflite_selectpicker_dom( 'locale', 'field_date_locale-{arf_field_id}', '', '', 'en', array(), $locales );
                    ?>
				</div>
			</div>
			<div class="arf_field_option_content_cell" data-sort="-1" id="calendartimehideshow">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Show time picker', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
					<label class="arf_js_switch_label">
						<span><?php echo  __( 'NO', 'arforms-form-builder' ) ; ?>&nbsp;</span>
					</label>
			...
			<div class="arf_field_option_content_cell arf_time_settings_{arf_field_id}" id="clocksetting">
				<label class="arf_field_option_content_cell_label"><?php echo __( 'Clock Settings', 'arforms-form-builder' ); ?></label>
				<div class="arf_field_option_content_cell_input">
					<?php
                        $time_options = array(
                            '12' => '12',
                        ...
                        echo $arflitemaincontroller->arflite_selectpicker_dom( 'clock', 'field_time_clock-{arf_field_id}', '', 'width: 43%;', '12', $time_attr, $time_options );
                        ...
                        echo $arflitemaincontroller->arflite_selectpicker_dom( 'step', 'time_step-{arf_field_id}', '', 'width: 43%; margin-left: 10px; clear: none;', '30', array(), $step_options );
                    ?>
					<span class="arf_field_option_input_note arf_time_field_options_note">
						<span class="arf_field_option_input_note_text arf_half_width"><?php echo  __( 'Hour', 'arforms-form-builder' ) ; ?></span>
						<span class="arf_field_option_input_note_text arf_half_width"><?php echo  __( 'Minute', 'arforms-form-builder' ) ; ?></span>
					</span>
				</div>
			</div>
			<div class="arf_field_option_content_cell arf_full_width_cell" id="offdays">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Off days', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
					<input type="hidden" name="off_days" id="arf_off_days_{arf_field_id}" class="txtstandardnew arf_date_days_val" value="" size="4"/>
					<div class="arf_date_days_btn" day_val="0"><?php echo  __( 'Sunday', 'arforms-form-builder' ) ; ?></div>
					<div class="arf_date_days_btn" day_val="1"><?php echo  __( 'Monday', 'arforms-form-builder' ) ; ?></div>
					<div class="arf_date_days_btn" day_val="2"><?php echo  __( 'Tuesday', 'arforms-form-builder' ) ; ?></div>
					<div class="arf_date_days_btn" day_val="3"><?php echo  __( 'Wednesday', 'arforms-form-builder' ) ; ?></div>
					<div class="arf_date_days_btn" day_val="4"><?php echo  __( 'Thursday', 'arforms-form-builder' ) ; ?></div>
					<div class="arf_date_days_btn" day_val="5"><?php echo  __( 'Friday', 'arforms-form-builder' ) ; ?></div>
					<div class="arf_date_days_btn" day_val="6"><?php echo  __( 'Saturday', 'arforms-form-builder' ) ; ?></div>
				</div>
			</div>
			<div class="arf_field_option_content_cell" data-sort="-1" id="daterange">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Date range', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
					<label class="arf_field_option_content_cell_label"><?php echo  __( 'From', 'arforms-form-builder' ) ; ?></label>
					...
					<span class="arf_field_option_input_note arf_date_range_option_note">
						<label class="arf_js_switch_label">
							<span class="arf_current_date_hide_show_label"><?php echo  __( 'Set Current Date', 'arforms-form-builder' ) ; ?>:&nbsp;</span>
							<span><?php echo  __( 'NO', 'arforms-form-builder' ) ; ?>&nbsp;</span>
						</label>
						<span class="arf_js_switch_wrapper arf_no_transition">
						...
						<span class="arf_field_option_input_note arf_time_field_options_note">
						<span class="arf_field_option_input_note_text"><?php echo  __( 'Min Date e.g. 20/01/2000', 'arforms-form-builder' ) ; ?></span>
						</span>
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="daterange">
				...
				<div class="arf_field_option_content_cell_input">
					<label class="arf_field_option_content_cell_label"><?php echo  __( 'To', 'arforms-form-builder' ) ; ?></label>
					...
					<span class="arf_field_option_input_note arf_date_range_option_note">
						...
						<span class="arf_field_option_input_note arf_time_field_options_note">
						<span class="arf_field_option_input_note_text"><?php echo  __( 'Max Date e.g. 31/12/2020', 'arforms-form-builder' ) ; ?></span>
						</span>
					</span>
				</div>
			</div>
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="set_default_selected_date">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Set default date', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
					...
					<div class="arf_field_option_input_note arf_date_range_option_note">
						<label class="arf_js_switch_label">
							<span class="arf_current_date_hide_show_label"><?php echo  __( 'Set Current Date:', 'arforms-form-builder' ) ; ?>&nbsp;</span>
							<span><?php echo  __( 'NO', 'arforms-form-builder' ) ; ?>&nbsp;
						</label>
						...
						<span class="arf_field_option_input_note arf_time_field_options_note" >
							...
							?>
						<span class="arf_field_option_input_note_text" id='arf_date_field_set_def_date'><?php echo  __( $date_eg, 'arforms-form-builder' ) ; ?></span>
			...
			<div class="arf_field_option_content_cell_htmlcontent arf_field_option_content_cell" data-sort="-1" id="htmlcontent">
				<div class="arf_field_option_content_cell arf_field_height20 arf_full_width_cell">
					...
					<label class="arf_js_switch_label" for="arfenable_total_{arf_field_id}">
						<span>&nbsp;<?php echo  __( 'Enable Running Total', 'arforms-form-builder' ) ; ?></span>
						<span class="arflite_pro_version_notice arflite_pro_notice_with_title">(Availabel in Premium)</span>
					</label>
				</div>

				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Content', 'arforms-form-builder' ) ; ?></label>
				...
				<div class="arf_field_option_content_cell_input">
					...
					<span class="arf_field_option_input_note arfwidth50">
						 <span class="arf_field_option_input_note_text arfliterunning-total-note">[ <?php echo  __( 'Embedded tags for youtube, map etc are supported.', 'arforms-form-builder' ) ; ?> ]
						</span>
					</span>
				</div>
			</div>
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="fontfamilyoption">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Font family', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
					...
					<dl class="arf_selectbox" data-name="arf_section_font" data-field-id="{arf_field_id}" data-id="field_arf_section_font_{arf_field_id}">
						...
						<dd>
							<ul class="display-none-cls" data-id="field_arf_section_font_{arf_field_id}">
								<ol class="arp_selectbox_group_label"><?php echo  __( 'Default Fonts', 'arforms-form-builder' ) ; ?></ol>
								...
								<ol class="arp_selectbox_group_label"><?php echo  __( 'Google Fonts', 'arforms-form-builder' ) ; ?></ol>
								<?php
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="fontsizeoption">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Font size', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
					...
					<dl class="arf_selectbox" data-name="arf_section_font_size" data-field-id="{arf_field_id}" data-id="field_arf_section_font_size_{arf_field_id}">
						...
						<dd>
							<ul class="display-none-cls" data-id="field_arf_section_font_size_{arf_field_id}">
								<?php for ( $i = 8; $i <= 20; $i ++ ) { ?>
									<li class="arf_selectbox_option" data-value="<?php echo esc_html ( $i ); ?>" data-label="<?php echo htmlentities( $i ); ?>"><?php echo addslashes( $i ); ?></li>
								<?php } ?>
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="fontstyleoption">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Font style', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
					...
					<dl class="arf_selectbox" data-name="arf_section_font_style" data-field-id="{arf_field_id}" data-id="field_arf_section_font_style_{arf_field_id}">
						...
						<dd>
							<ul class="display-none-cls" data-id="field_arf_section_font_style_{arf_field_id}">
								<li class="arf_selectbox_option" data-value="normal" data-label="<?php echo  __( 'normal', 'arforms-form-builder' ) ; ?>"><?php echo  __( 'normal', 'arforms-form-builder' ) ; ?></li>
								<li class="arf_selectbox_option" data-value="bold" data-label="<?php echo  __( 'bold', 'arforms-form-builder' ) ; ?>"><?php echo  __( 'bold', 'arforms-form-builder' ) ; ?></li>
								<li class="arf_selectbox_option" data-value="italic" data-label="<?php echo  __( 'italic', 'arforms-form-builder' ) ; ?>"><?php echo  __( 'italic', 'arforms-form-builder' ) ; ?></li>
							</ul>
						</dd>
					</dl>
				</div>
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="arf_input_custom_validation">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Validation', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
					<?php
                        ...
                        echo $arflitemaincontroller->arflite_selectpicker_dom( 'single_custom_validation', 'single_custom_validation_{arf_field_id}', '', '', 'custom_validation_none', $validation_attr, $validation_opts );
                    ?>
				</div>
			</div>
			<div class="arf_field_option_content_cell" data-sort="-1" id="arf_regular_expression_msg">
				<label class="arf_field_option_content_cell_label"><?php echo __( 'Message for regular expression', 'arforms-form-builder' ); ?></label>
				<div class="arf_field_option_content_cell_input">
					<input id="arf_regular_expression_msg_{arf_field_id}" type="text" name="arf_regular_expression_msg" value="<?php echo  __( 'Entered value is invalid', 'arforms-form-builder'  ); ?>" class="arf_field_option_input_text txtstandardnew arfblank_txt" disabled="disabled"/>
				</div>
			</div>
			<div class="arf_field_option_content_cell" data-sort="-1" id="arf_regular_expression">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Regular expression', 'arforms-form-builder' ) ; ?>
					<span class="arf_popup_tooltip_main arfhelptip tipso_style " data-title="<strong><?php echo __( 'Sample RegExp', 'arforms-form-builder' ); ?></strong><br><div class='arflite_text_align_left'><strong><?php echo '[0-9]{6} '; ?></strong><?php echo __( 'Allow only digits upto 6 digits. e.g. : pincode', 'arforms-form-builder' ); ?><br><strong><?php echo '[a-zA-Z0-9]{8,16}'; ?></strong> <?php echo __( 'Allow alpha numeric characters and length must be between 8 to 16 characters', 'arforms-form-builder' ); ?><br><strong><?php echo '\([\d]{3}\)\-[\d]{7}'; ?> </strong> <?php echo __( 'Allow phone number like', 'arforms-form-builder' ) . ' (123)-1234567'; ?></div>">
					<img class="arflitephntypehelpicon" src="<?php echo ARFLITEIMAGESURL; ?>/tooltips-icon.png" alt="?"/></span>
				</label>
				<div class="arf_field_option_content_cell_input">
					...
					<span class="arf_pre_regex arf_pre_regex_{arf_field_id} arf_pre_regex_disable" data-field-id="{arf_field_id}" data-pattern="(http(s)?:\/\/)?([\da-z\.-]+)\.([a-z\.]{2,6})([\/\w \.-]*)*\/?"><?php echo  __( 'URL', 'arforms-form-builder' ) ; ?></span>
					<span class="arf_pre_regex arf_pre_regex_{arf_field_id} arf_pre_regex_disable" data-field-id="{arf_field_id}" data-pattern="(?:(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)\.){3}(?:25[0-5]|2[0-4][0-9]|[01]?[0-9][0-9]?)"><?php echo  __( 'IP Address', 'arforms-form-builder' ) ; ?></span>
					<span class="arf_pre_regex arf_pre_regex_{arf_field_id} arf_pre_regex_disable" data-field-id="{arf_field_id}" data-pattern="[a-z0-9_-]{3,16}"><?php echo  __( 'User Name', 'arforms-form-builder' ) ; ?></span>
					<span class="arf_pre_regex arf_pre_regex_{arf_field_id} arf_pre_regex_disable" data-field-id="{arf_field_id}" data-pattern="[0-9]{3,4}"><?php echo  __( 'CVC/CVV', 'arforms-form-builder' ); ?></span>
				</div>
			</div>
			<div class="arf_field_option_content_cell" data-sort="-1" id="istooltip">
				<label class="arf_field_option_content_cell_label"><?php echo  __( 'Tooltip', 'arforms-form-builder' ) ; ?></label>
				<div class="arf_field_option_content_cell_input">
					<label class="arf_js_switch_label">
						<span><?php echo  __( 'NO', 'arforms-form-builder' ) ; ?>&nbsp;</span>
					</label>
			...
			<div class="arf_field_option_content_cell" data-sort="-1" id="tooltipmsg">
				<label class="arf_field_option_content_cell_label"><?php echo __( 'Message for tooltip', 'arforms-form-builder' ); ?></label>
	...
	<div class="arf_field_option_model_footer">
		<button type="button" class="arf_field_option_close_button" id="arf_field_option_close_button"><?php echo  __( 'Cancel', 'arforms-form-builder' ) ; ?></button>
		<button type="button" class="arf_field_option_submit_button" data-field_id=""><?php echo __( 'OK', 'arforms-form-builder' ); ?></button>
	</div>
</div>
