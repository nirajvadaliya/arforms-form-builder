...
<div class='arf_modal_overlay'>
	...
	<div class='arf_popup_container arf_insert_popup_modal' id="arflite_insert_popup_modal">
		<div class='arf_popup_container_header'><?php echo  __( 'ADD ARFORMS LITE FORM', 'arforms-form-builder' ) ; ?>        
		</div>
		<div class='arfinsertform_modal_container arf_popup_content_container'>
			<div class="main_div_container">
				<div class="select_form arfmarginb20">
					<label><?php echo  __( 'Select a form to insert into page', 'arforms-form-builder' ) ; ?>&nbsp;<span class="newmodal_required">*</span></label>
					<div class="selectbox">
		...
		<div class="arf_popup_container_footer">
			<button type="button" class="arf_field_option_close_button" onclick="arflite_close_field_option_popup();"><?php echo  __( 'Cancel', 'arforms-form-builder' ) ; ?></button>
			<button type="button" class="arf_field_option_submit_button" id="arfcontinuebtn" onclick="arfliteinsertform();"><?php echo  __( 'Add to page', 'arforms-form-builder' ) ; ?></button>            
		</div>
	</div>
</div>
